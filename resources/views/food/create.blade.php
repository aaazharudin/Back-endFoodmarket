                ...
                <form class="w-full" action="{{ route('food.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('ingredients') }}" name="ingredients" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Kandungan dan Nutrisi">
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Buah naga mengandung vitamin c dan serat. Sehingga membantu menjaga imunitas tubuh dan kesehatan pencernaan</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Sayur, Bumbu, Daging</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
