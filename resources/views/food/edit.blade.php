                ...
                <form class="w-full" action="{{ route('food.update', $item->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Dipisahkan dengan koma, contoh: Buah naga mengandung vitamin c dan serat. Sehingga membantu menjaga imunitas tubuh dan kesehatan pencernaan</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Sayur_Segar, Bumbu_Dapur, Daging</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
